...
// ES module route
 ...
 // }) 
        ...
        (async ()=>{                                 // '(':- IIFE :-which means function can call right away
         const {welcome} = await import ('./controllers/ moduleType.mjs')   // This is a dynamic import syntax used to load ES Modules (.mjs). We cant use 'require in ES modules. so use await import dynamicall
         app.get('/welcome',welcome)
        })()
