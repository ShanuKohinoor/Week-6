   ...
   //    res.render('doctors',{title:'All Doctors',doctors})} 
    ...
    // Data base will take time. So it is an asynchronous function. So we use async await to handle asynchronous. Here we dont have Database. So, we simulate it from our data for solving asynch.
