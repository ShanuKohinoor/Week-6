...
// ES module route
 ...
 /*
        (async ()=>{                                 // '(':- IIFE :-which means function can call right away
         const {welcome} = await import ('./controllers/ moduleType.mjs')  
                                                 // const {welcome}:- welcome destructures welcome function from the imported module file
                                                                        //  moduleType.mjs(the file inside controllers)
                                                             // export const welcome = (req, res) => {
                                                             // res.send('Welcome!');
                                                             // };
 
                                                 // This is a dynamic import syntax used to load ES Modules (.mjs). We cant use 'require in ES modules. so use await import dynamically.
        
         app.get('/welcome',welcome)            //when visit welcome route..it calls welcome function( which is inside controllers, moduleType.mjs file)
        })()
*/
